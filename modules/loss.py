...
if __name__ == '__main__':
    ...
    loss = hierarchical_contrastive_loss(device)
    ntx_loss = NTXentLoss_poly(device, batch_size=5, temperature=0.2, use_cosine_similarity=True)
    z1 = torch.rand(5, 10, 128)
    z2 = torch.rand(5, 10, 128)
    l = loss(z1, z2)
    z1 = torch.rand(5, 128)
    z2 = torch.rand(5, 128)
    ln_ = ntx_loss(z1, z2)